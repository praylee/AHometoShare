...
public class PropertyBusinessLayerTest {
    ...
    public void testGetAllProperty() {
        ...
        PropertyBusinessLayer instance = new PropertyBusinessLayer();
    ...
    /**
     * Test of getPropertyById method, of class PropertyBusinessLayer.
     */
    @Test
    public void testGetPropertyById() {
        System.out.println("getPropertyById");
        int propertyId = 0;
        PropertyBusinessLayer instance = new PropertyBusinessLayer();
        Property expResult = null;
        Property result = instance.getPropertyById(propertyId);
        assertEquals(expResult, result);
        // TODO review the generated test code and remove the default call to fail.
        fail("The test case is a prototype.");
    }
    ...
    /**
     * Test of updatePropertyupdateProperty method, of class PropertyBusinessLayer.
     */
    @Test
    public void testUpdatePropertyupdateProperty() {
        System.out.println("updatePropertyupdateProperty");
        int hostId = 0;
        String address = "";
        String city = "";
        String postalCode = "";
